...
export const increaseCount = (productList, propsData) => {
  ...
  if (checkProductQty(updated_qty, productList[current_idx].availableQty))
    return true;
  ...
  const response = updateProductCart(
    POST_CONFIG(JSON.stringify(update_cart_data))
  );
...
export const composeOrderDataPayWith = (
  shop_cart = {},
  payment_id = 0,
...
export const composePaymentInfo = (
  payment_id = 0,
  bank_id = 0,
  phone_no = '',
  remark = '',
...
// Cash on Delivery
export const composePostOrderData = (
  shop_cart = {},
  ...
  let delivery = {
    ...
    fromTime:  delivery_info?.fromEstDeliveryDay.toString(),
    toTime: delivery_info?.toEstDeliveryDay.toString(),
    landMark: '',
