...
const ProductCard_Category_Mobile = ({ productData = {}, onClickWishList }) => {
    ...
    >
      ...
      <button
        onClick={(e) => {
          e.stopPropagation();
          setIsFav(!isFav);
          onClickWishList(productData.productId, productData.isFav);
...
export default ProductCard_Category_Mobile;
