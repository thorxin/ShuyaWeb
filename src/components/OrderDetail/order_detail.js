              ...
              <div className='md:space-y-6'>
                ...
                <div className='bg-white pt-4 md:pt-0'>
                  <div className='mx-4 md:mx-auto space-y-6'>
                    <div className='flex justify-between items-center -mb-4'>
                      ...
                      <p className='sub-heading-font text-color-default hidden md:block'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-8'>
                  <div className='col-span-5 md:space-y-6'>
                    ...
                    {/* Order Item For Web*/}
                    <div className='hidden md:block'>
                      <OrderItem itemList={OrderDetail?.orderItem} DiscountPrice={OrderDetail.deliveryInfo.discountPrice} />
                    </div>
                    {/* End Order Item  */}
                    <div className=' h-0.5 bg-gray-200 hidden md:block' />
                  </div>
                    ...
                    <div className='bg-white py-4 md:py-0'>
                      <div className='mx-4 md:mx-auto  grid grid-cols-2 gap-y-3'>
                        ...
                        <AmountLabel
                          ...
                          Amount={
                              OrderDetail.deliveryFee > 0 ? OrderDetail.deliveryFee: 2000
                          }
                          currency={t('Common.kyats')}
                        />
                        {/* <AmountLabel
