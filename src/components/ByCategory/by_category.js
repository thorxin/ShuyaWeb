                  ...
                  {mainCategoryDetail.map((item, index) => (
                    ...
                    >
                      ...
                      <div
                        className={
                          selectedCategory.id === item.id
                            ? 'md:pr-6 pr-1 my-auto tertiary-font text-color-brown custom-font-bold line-clamp-2'
                            : 'md:pr-6 pr-1 my-auto tertiary-font text-color-default custom-font-bold line-clamp-2'
                        }
                      >
                        {item.name}
                      </div>
